...
export function BookingFlow({ initialServiceId }: BookingFlowProps) {
  ...
  if (success) {
    return (
      <div className="card mx-auto max-w-lg text-center">
        ...
        <h2 className="font-display text-3xl text-accent">¡Reserva confirmada!</h2>
  ...
  return (
    <div className="card mx-auto max-w-lg">
            ...
            {services.map((s) => (
              ...
              >
                <div className="flex justify-between">
                  ...
                  <span className="text-accent">{formatPriceCents(s.priceCents)}</span>
                </div>
      ...
      {step === 2 && (
        <div className="space-y-4">
          <h2 className="font-display text-2xl">Elige fecha</h2>
      ...
      {step === 3 && (
        <div className="space-y-4">
          <h2 className="font-display text-2xl">Elige hora</h2>
